"""
This script transforms the diffusion tracts from native space to MNI
...
if __name__ == "__main__":
    ...
    for sub, ses in sub_ses.items():
        ...
        tmp_dir = os.path.join(
            DATA_ROOT, "derivatives", sub, ses, "dwi", "tract2mni_tmp"
        )
        ...
        os.system(
            f"wget http://www.bic.mni.mcgill.ca/\~vfonov/icbm/2009/mni_icbm152_nlin_sym_09a_nifti.zip -P {tmp_dir}"
        )
        os.system(
